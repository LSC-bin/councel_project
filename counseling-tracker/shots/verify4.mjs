...
await page.goto('http://localhost:8935/#/input', { waitUntil: 'networkidle' });
await page.waitForTimeout(800);
await page.screenshot({ path: 'shots/v4-input.png' });
await page.goto('http://localhost:8935/#/search', { waitUntil: 'networkidle' });
await page.waitForTimeout(800);
await page.screenshot({ path: 'shots/v4-search.png' });
await browser.close();
server.close();
